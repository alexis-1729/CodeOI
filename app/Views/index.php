...
<div class="flex flex-row isolate  bg-hero">
    <div class="mx-auto max-w-2xl py-32 sm:py-40 lg:py-32">
      <div class="hidden sm:mb-8 sm:flex sm:justify-left">
        ...
        Lorem ipsum dolor sit amet, consectetur  <a href="#" class="font-semibold text-indigo-600"><span class="absolute inset-0" aria-hidden="true"></span>Read more <span aria-hidden="true">&rarr;</span></a>
        </div>
      </div>
      <div class="text-left">
        <h1 class="text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">Lorem ipsum dolor sit amet, consectetur</h1>
